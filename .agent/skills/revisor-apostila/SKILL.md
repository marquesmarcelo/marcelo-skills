...
**Regras da tabela:**
- Problemas recorrentes em múltiplos arquivos → Localização: `Global / Todos os arquivos`
...
1. Informar ao usuário: *"Analisei [N] de [Total] arquivos. Os achados parciais estão acima. Posso continuar com os arquivos restantes — basta solicitar."*
2. Manter consistência: ao continuar, referenciar achados anteriores para análise global.
3. Ao final de todos os lotes, oferecer consolidar o relatório completo.
